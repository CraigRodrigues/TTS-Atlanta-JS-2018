(function() {
  ...
  function checkForNativeMethods(runLowdasherFunction) {
    it('should not use the native version of any Lowdasher methods in its implementation', function() {
      // These spies are set up in testSupport.js
      runLowdasherFunction();
