...
* We will first work through a simple example of this with our counter then go through a more complex exampel from the React official documentation tutorial to create a temperature calculator that calculates whether the water would boil at a given temperature.
